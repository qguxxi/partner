...
fun ButtonsSection(onGoogleClick : () -> Unit , context : Context) {
    Column(
        ...
        PrivacyAndTerm(privacyOnClick = {
            openUrl("https://sites.google.com/view/synthinc/trang-ch%E1%BB%A7" , context)
        } , termServiceOnClick = {
            openUrl("https://sites.google.com/view/synth-inc/trang-ch%E1%BB%A7" , context)
        })
    }
}

// Hàm mở URL bằng Intent
